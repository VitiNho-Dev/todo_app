import 'package:app_todo/app/components/custom_floating_action_button.dart';
import 'package:app_todo/app/modules/add_items/domain/entities/item_entity.dart';
import 'package:app_todo/app/components/custom_show_dialog_widget.dart';
import 'package:app_todo/app/modules/add_items/presenter/page_todo/widgets/custom_list_items.dart';
...
import 'package:app_todo/app/components/custom_app_bar_widget.dart';
...
class _PageTodoState extends State<PageTodo> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<TodoBloc, BlocState>(
          bloc: bloc,
      ...
      floatingActionButton: CustomFloatingActionButton(
        onPressed: () => showModalBottomSheet<String>(
          ...
          builder: (context) {
            return BlocBuilder<TodoBloc, BlocState>(
              bloc: bloc,
              builder: (context, state) {
                return Padding(
